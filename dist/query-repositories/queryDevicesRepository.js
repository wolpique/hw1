...
exports.QueryDevicesRepository = void 0;
const device_schema_1 = require("../domain/schemas/device.schema");
class QueryDevicesRepository {
    static getAllDevicesByUser(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            const devices = yield device_schema_1.DevicesModelClass
                .find({ userId })
                .lean();
...
exports.QueryDevicesRepository = QueryDevicesRepository;
